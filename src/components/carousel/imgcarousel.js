    ...
    return (
        <div>
            ...
            >
                ...
                <SwiperSlide style={{ position: 'relative', height:"640px" }}>
                    <img className='object-fit-cover' src="/assets/img/i4.jpg" alt="planta" style={{ filter: "brightness(0.55)" }}/>
                    <div className="carousel-text">
                    Renove seu jardim <br/>com <span>preços especiais</span>!
                    </div>
                </SwiperSlide>
                <SwiperSlide style={{ position: 'relative', height:"640px" }}>
                    <img className='object-fit-cover h-100' src="/assets/img/i2.jpg" alt="planta" style={{ filter: "brightness(0.62)" }}/>
                    <div className="carousel-text">
                    Transforme sua casa <br/><span>com descontos</span>!
                    </div>
                </SwiperSlide>
                <SwiperSlide style={{ position: 'relative', height:"640px" }}>
                    <img className='object-fit-cover h-100' src="/assets/img/i3.jpg" alt="planta" style={{ filter: "brightness(0.70)" }}/>
                    <div className="carousel-text">
